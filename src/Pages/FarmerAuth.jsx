                ...
                <div style={{ position: "relative", zIndex: 1 }} className="container-fluid d-flex align-items-center justify-content-center h-100">
                    <div
                        ...
                        :<h4 style={{ fontWeight: "700" }}>Hello, <br /> Welcome Back</h4>}
                            ...
                            {isRegister && 
                            <input value={userDetails.place} onChange={(e)=>setUserDetails({...userDetails,place:e.target.value})} type="text" className="mb-3 w-100" placeholder="Place" style={{ borderRadius: "30px", padding: "10px 20px", fontSize: "13px", border: "1px solid grey", outline: "none" }} />}
                            {isRegister?
                            <button
